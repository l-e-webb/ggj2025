...
const GUM_BUBBLE_RISE_ACCEL = 2.
const GUM_BUBBLE_RISE_MAX_SPEED = 1.5
const GUM_BUBBLE_DRIFT_AMPLITUDE = 0.5
const GUM_BUBBLE_DRIFT_FREQUENCY = 1.5

const ELEVATOR_BUBBLE_RISE_ACCEL = 3.
const ELEVATOR_BUBBLE_RISE_MAX_SPEED = 1.5
const ELEVATOR_BUBBLE_FALL_MAX_ACCEL = -3.
const ELEVATOR_BUBBLE_FALL_MAX_SPEED = -1.5
const ELEVATOR_BUBBLE_DRIFT_AMPLITUDE = 0.5
const ELEVATOR_BUBBLE_DRIFT_FREQUENCY = 1.5
